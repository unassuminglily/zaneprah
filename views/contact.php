		...
		<div class="container">
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form id="contact-form" method="post" action="../actions/contact_process.php" role="form">
						...
						<div id="cf-submit">
							<button type="submit" id="contact-submit" class="btn btn-transparent" value="Submit">Send Message</button>
						</div>						
				...
				<div class="contact-details col-md-6 " >
					...
					<ul class="contact-short-info" >
						<li>
							...
							<span>Lancaster, GB</span>
						</li>
	
						<li>
							<i class="tf-ion-android-mail"></i>
							<span>Email: help@zaneprah.com</span>
						</li>
					</ul>
					<!-- Footer Social Links -->
